...
export const LENS_PROFILES: Record<LensProfileId, LensProfile> = {
  food_dining: {
    ...
    uiCopy: {
      ...
      activeLabel: "Easy food",
      transitionCopy: "Looking for the easiest good option",
    },
    fallbackHints: [
      "Find a casual cafe for a low-effort bite",
