    ...
    if (this.state.error) {
      return (
        ...
        >
          ...
          <p className="max-w-[240px] text-center text-xs leading-snug text-ink/65">
            Your decision is still safe. Try reopening this panel.
          </p>
          <button
            type="button"
            onClick={this.handleReset}
            className="h-9 rounded-xl border border-line px-4 text-sm font-medium text-ink/70 transition-colors active:bg-line/20"
          >
            Reopen
          </button>
        </div>
