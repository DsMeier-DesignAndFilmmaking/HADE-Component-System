...
import { HeroDecisionCard } from "@/components/hade/mobile/HeroDecisionCard";
import { RefineSheet } from "@/components/hade/mobile/RefineSheet";
import { VibeSheet } from "@/components/hade/mobile/VibeSheet";
import { UgcVerificationSheet } from "@/components/hade/mobile/UgcVerificationSheet";
import { LoadingState } from "@/components/hade/mobile/LoadingState";
import { ErrorBoundary } from "@/components/hade/mobile/ErrorBoundary";
import { ActivityCreationView } from "@/components/hade/mobile/ActivityCreationView";
import { CompareModesSheet } from "@/components/hade/mobile/CompareModesSheet";
import { VoiceSheet } from "@/components/hade/mobile/VoiceSheet";
...
const LENS_OPTIONS: Array<{
  ...
  icon: string;
  label: string;
  context: string; // Now acts as the compelling value prop / subtitle
  frame: string;   // Now acts as the context-aware system trigger
...
}> = [
  {
    ...
    icon: "🍽",
    label: "Food & Dining",
    context: "Smarter eats, zero decision fatigue.",
    frame: "Analyzing immediate hyper-local dining options.",
  ...
  },
  {
    ...
    context: "Inspiration over endless scrolling.",
    frame: "Curating unique, independent spots steps away.",
  ...
  },
  {
    ...
    context: "Your quickest way out or through.",
    frame: "Mapping real-time transit and local density.",
  ...
  },
  {
    ...
    icon: "🎭",
    label: "Entertainment",
    context: "Find what's happening right now.",
    frame: "Filtering live events and venues around you.",
  ...
  },
  {
    ...
    context: "Low-pressure, spontaneous connection.",
    frame: "Locating social hubs with matching energy.",
  ...
  },
  {
    ...
    icon: "🌿",
    label: "Wellness",
    context: "A quick mental or physical reset.",
    frame: "Matching restorative spaces to your current energy.",
