...
function makeConfig(overrides = {}) {
  return core.loadConfig(overrides, { clientId: "testkit-client" });
}
...
function makeDecisionEngineOutput(decisionOverrides = {}, outputOverrides = {}) {
  ...
  const base = core.fromHadeDecision(decision, {
...
exports.makeDecisionEngineOutput = makeDecisionEngineOutput;
exports.makeVenueCandidate = makeVenueCandidate;
exports.mockCacheAdapter = mockCacheAdapter;
exports.mockGeoAdapter = mockGeoAdapter;
exports.mockLLMAdapter = mockLLMAdapter;
exports.mockVenueAdapter = mockVenueAdapter;
exports.resetDecisionCounter = resetDecisionCounter;
exports.resetVenueCandidateCounter = resetVenueCandidateCounter;
