...
type AdapterKind = "venue" | "llm" | "cache" | "geo";
...
interface VenueSearchNearbyOptions {
    geo: GeoCoords;
...
interface VenueMultiQueryOptions {
    geo: GeoCoords;
...
interface LLMAdapter {
    readonly id: string;
    enhanceCopy(prompt: string, options?: {
        timeout_ms?: number;
        model?: string;
    }): Promise<{
        rationale?: string;
...
interface HadeAdapters {
    venue: VenueAdapter;
    llm?: LLMAdapter;
    cache?: CacheAdapter;
    geo?: GeoAdapter;
}
type PartialHadeAdapters = {
    venue?: VenueAdapter;
    llm?: LLMAdapter;
    cache?: CacheAdapter;
    geo?: GeoAdapter;
...
export type { AdapterHealth as A, CacheAdapter as C, GeoAdapter as G, HadeAdapters as H, LLMAdapter as L, PartialHadeAdapters as P, VenueAdapter as V, AdapterKind as a, GeoCoords as b, VenueCandidate as c, VenueContextLike as d, VenueMultiQueryOptions as e, VenueSearchNearbyOptions as f };
