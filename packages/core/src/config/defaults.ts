...
export const DEFAULT_CONFIG_HASH = "sha256:unconfigured" as const;
 ...
 */
export const BUILT_IN_SCORING_PROFILES: Readonly<Record<string, HadeScoringProfile>> = {
  balanced:      { proximity: 0.40, signal: 0.35, intent: 0.25 },
  intent_heavy:  { proximity: 0.25, signal: 0.25, intent: 0.50 },
  signal_heavy:  { proximity: 0.25, signal: 0.50, intent: 0.25 },
  rating_heavy:  { proximity: 0.10, signal: 0.45, intent: 0.45 },
 ...
 */
export const BUILT_IN_DOMAINS: Readonly<Record<string, Required<HadeDomainConfig>>> = {
  dining: {
    id: "dining",
    display_name: "Dining",
...
export const DEFAULT_HADE_CONFIG: ResolvedHadeConfig = {
  defaults: {
    radius_meters: 800,
    locale: "en-US",
  ...
  confidence: {
    ...
    node: {
      ...
      recency_fresh_ms: 2 * 60 * 60 * 1000,
      recency_recent_ms: 6 * 60 * 60 * 1000,
      recency_day_ms: 24 * 60 * 60 * 1000,
      recency_fresh_score: 1.0,
  ...
  copy: {
    ...
    tone: "casual",
    char_caps: {
      rationale: 280,       // route.ts:904
      why_now: 120,         // route.ts:905
      why_this: 60,         // route.ts:906
      decision_frame: 180,  // route.ts:907
    },
    fallback_titles: [      // route.ts:129-133
      "Take a walk nearby",
      "Grab coffee nearby",
      "Explore this area",
    ],
  ...
  mobility: {
    walking_meters_per_minute: 80,   // route.ts:294, 1137
