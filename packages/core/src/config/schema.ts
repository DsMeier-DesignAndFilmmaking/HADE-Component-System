 ...
 */
export type HadeSchemaVersion = "1.0";

export interface HadeConfigDefaults {
...
export interface HadeProductConfig {
  readonly id: string;
 ...
 */
export interface HadeDomainConfig {
  readonly id: string;
...
export interface HadeScoringProfile {
...
export interface HadeCopyConfig {
  readonly locale?: string;
...
export interface HadeRuntimeConfig {
 ...
 */
export interface HadeAdapterMetadata {
  readonly id: string;
  readonly notes?: string;
}

export interface HadeAdaptersMetadata {
...
export interface HadeConfidenceBandConfig {
...
export interface HadeConfidenceLabelConfig {
  readonly strong_pick?: number;
  readonly good_fit?: number;
}

export interface HadeNodeConfidenceConfig {
...
export interface HadeSyntheticConfidenceConfig {
  readonly default_score?: number;
  readonly min_score?: number;
  readonly max_score?: number;
...
export interface HadeConfidenceConfig {
...
export interface HadeTimeoutConfig {
...
export interface HadeOpportunityWeightConfig {
  readonly proximity?: number;
  readonly signal?: number;
  readonly intent?: number;
}

export interface HadeConfidenceWeightConfig {
...
export interface ResolvedHadeConfig {
  readonly $schema_version: HadeSchemaVersion;
  readonly product?: HadeProductConfig;
