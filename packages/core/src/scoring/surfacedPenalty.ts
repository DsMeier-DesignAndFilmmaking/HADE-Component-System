...
export const SURFACED_ONCE_PENALTY = DEFAULT_HADE_CONFIG.scoring.surfaced_once_penalty;
/** Stronger penalty when a candidate has been shown twice or more this session. */
export const SURFACED_TWICE_PENALTY = DEFAULT_HADE_CONFIG.scoring.surfaced_twice_penalty;
